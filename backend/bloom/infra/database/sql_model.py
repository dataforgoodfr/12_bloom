...
class Zone(Base):
    ...
    beneficiaries = Column("beneficiaries", String)
...
class Segment(Base):
    ...
    type = Column("type", String)
    in_amp_zone = Column("in_amp_zone", Integer)
    in_territorial_waters = Column("in_territorial_waters", Integer)
    in_zone_with_no_fishing_rights = Column("in_zone_with_no_fishing_rights", Integer)
