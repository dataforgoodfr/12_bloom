...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("total_time_fishing_in_zones_with_no_fishing_rights", sa.Interval),
        sa.Column("total_time_default_ais", sa.Interval),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column("in_amp_zone", sa.Integer),
        sa.Column("in_territorial_waters", sa.Integer),
        sa.Column("in_zone_with_no_fishing_rights", sa.Integer),
