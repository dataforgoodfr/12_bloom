...
last_vessel_raw_positions as (
    select 
        ...
        from dim_vessels
        left join {{ source('spire','spire_ais_data') }} spire on vessels.vessel_mmsi = spire.position_mmsi
        and utils.safe_between(spire.position_timestamp, vessels.mmsi_start_date, vessels.mmsi_end_date)
