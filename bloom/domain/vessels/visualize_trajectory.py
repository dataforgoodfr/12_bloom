...
def visualize(data,color_by_speed: bool = False, marker_by_fishing: bool = False,with_animation = False,min_speed = 2.0,max_speed = None,weight = 5,minutes_ais = 120,cmap=plt.cm.Spectral_r):
    ...
    stop_condition = ((data["timestamp"] - data["last_position_time"]) >= pd.Timedelta(minutes=minutes_ais)).tolist()
